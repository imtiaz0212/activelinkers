...
<div>
    ...
    <div class="panelHeader">
        <h3 class="panelHeaderTitle">Create Package</h3>
                ...
                <div class="grid gap-4">
                    <div class="grid gap-1.5">
                        ...
                        <select id="select_service" name="service_id" class="inputField" required>
                            ...
                            <option value="{{ $service->id }}">{{ strFilter($service->title) }}</option>
                            @endforeach
                            @endif
                        </select>
                    </div>
                    ...
                    <div class="grid gap-1.5">
                        ...
                        <textarea class="inputField" name="short_description" id="serviceDesc"></textarea>
                    </div>
                    ...
                    <div class="grid gap-1.5">
                        ...
                        <div id="package_price_tab_content">
                            <div class="hidden" id="monthly" role="tabpanel" aria-labelledby="monthly-tab">
                                <input type="text" name="monthly" placeholder="Monthly Amount" class="inputField" />
                            </div>

                            <div class="hidden" id="yearly" role="tabpanel" aria-labelledby="yearly-tab">
                                <input type="text" name="yearly" placeholder="Yearly amount" class="inputField" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center cursor-pointer">
                        <input id="isRecommended" type="checkbox" name="is_recommended"
