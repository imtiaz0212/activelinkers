...
<div>
    ...
    <div class="panelHeader">
        <h3 class="panelHeaderTitle">Pages</h3>
        @if (canAccess(['pages create']))
        <a href="{{ route('admin.page.create') }}" class="button">
            Create Page
        ...
        <table class="table" id="dataTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th>
                        <img src="{{ $row->featured_image ? asset($row->featured_image) : asset('public/images/placeholder.png') }}"
                    ...
                    <td>
                        <a href="{{ url($row->page_url) }}" target="_blank"
