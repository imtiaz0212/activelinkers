...
<div ng-app="myApp" ng-controller="OrderController">
    ...
    <div class="panelHeader">
        <h3 class=" panelHeaderTitle">Create Order</h3>
        <a href="{{ route('admin.order') }}" class="button">
    ...
    <div class="shadow-md rounded p-5">
        <form action="{{ route('admin.order.store') }}" class="grid gap-6" method="POST">
            @csrf
            ...
            <div class="grid gap-4">
                ...
                <div class="grid lg:grid-cols-3 gap-5 items-start">
                    <div class="lg:col-span-1 grid gap-4">
                        ...
                        {{-- Name --}}
                        <div class="grid gap-1.5">
                            <label for="name" class="inputLabel">Name <span class="required">(*)</span></label>
                    ...
                    <div class="lg:col-span-2 grid gap-4">
                        ...
                        <div class="grid md:grid-cols-3 gap-4 items-end">
                            ...
                            <div>
                                <span class="button button--secondary h-[46px]" ng-click="addToCart()">
                                    Add To Cart
                                </span>
                            </div>
                        </div>
