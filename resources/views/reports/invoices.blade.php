...
<div>
    ...
    <div class="panelHeader">
        <h3 class="panelHeaderTitle">Invoice Reports</h3>
    </div>
            ...
            <tbody>
                ...
                <?php
                            $orders = DB::table('orders')
                                ->whereIn('id', json_decode($row->order_id))
                ...
                <tr>
                    ...
                    <td class="whitespace-nowrap">
                        ...
                        OrderID: #{{ $order->order_no }} - ${{ $order->grand_total }} USD <br />
                        @endforeach
                    </td>
...
<script>
    $(document).ready(function() {
        ...
        function getFilterData(reset = '') {
            let mainUrl = "{{ route('admin.reports.invoices') }}";
            ...
            if (reset) {
                location.href = "{{ route('admin.reports.invoices') }}";
            } else {
