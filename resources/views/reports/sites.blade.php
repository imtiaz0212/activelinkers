...
<div>
    ...
    <div class="panelHeader">
        <h3 class="panelHeaderTitle">Site Reports</h3>
    </div>
    ...
    <div class="mb-4 px-4">
        <div class="relative overflow-hidden shadow-sm border rounded mt-5 p-5">
            <div class="grid sm:grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <div class="md:col-span-1" id="custom_month">
    ...
    <div class="custom-data-table">
        <table id="dataTable">
            ...
            <tbody>
                {{-- @dd($info->results) --}}
                @php($totalAmount = $other_price = $artical = $urlPrice = $totalSubtotal = $totalServiceCharge =
                $totalTax = $totalDiscount = 0)
                ...
                <tr>
                    ...
                    <td>
                        <strong>Live Link:</strong> <span>{{ $row->live_url }}</span>

                        <div class="flex flex-wrap gap-x-3 gap-y-1 w-full">
                            ...
                            <a href="{{ $anchor->link }}" target="_blank"
                                class="font-medium text-blue-500 duration-300 hover:text-blue-600 underline whitespace-nowrap">
                                {{ $anchor->anchor_text }}
                            </a>
                            @endif
                            @endforeach
            ...
            <tfoot>
                <tr>
                    <th colspan="7" class="total text-right">
                        Total
                    </th>
...
<script>
    $(document).ready(function() {
        ...
        function getFilterData(reset = '') {
            let mainUrl = "{{ route('admin.reports.sites') }}";
            ...
            if (reset) {
                location.href = "{{ route('admin.reports.sites') }}";
            } else {
