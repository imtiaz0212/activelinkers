...
@section('headerMeta')
<title>{{$siteInfo->site_name}} | Your Order Invoice Details</title>
...
<section class="section_padding font-syne">
    <div class="container">
        <div class="grid xl:grid-cols-[8fr_4fr] items-start gap-5">
            <div>
                {{-- Cards --}}
                <div
                    class="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 bg-[rgba(237,242,255,0.40)] rounded-[10px] border border-[#D5E1FF] divide-y sm:divide-y-0 sm:divide-x">
                    @foreach ($cardData as $key => $row)
                    <div class="flex flex-col items-center text-center overflow-hidden p-3">

                        <span class="text-secondary">{!!$row['icon']!!}</span>
                    ...
                    <div class="flex flex-col items-center text-center  overflow-hidden p-3">
                        <svg class="text-secondary" width="32" height="32" viewBox="0 0 40 40" fill="none"
                ...
                <div class="border my-5 border-[#D5E1FF]/40 rounded-[10px]">
                    <div
                        class="bg-[#18285D] rounded-t-[10px] border-[#D5E1FF] p-3 text-[#fff] text-2xl text-center font-medium shadow-md">
                        Invoice
                    </div>

                    {{-- Billing Details --}}
                    <div class="grid lg:grid-cols-2 gap-7 lg:gap-0 py-3 md:py-4">
                        <div class="lg:border-e-2 px-4 md:px-5">
                            <h2 class="text-black text-lg md:text-xl leading-none font-semibold mb-2">
                                Billing From
                            </h2>

                            <ul class="flex flex-col gap-0.5 md:gap-1 text-sm md:text-base text-[#515151]">
                        ...
                        <div class=" px-5 md:px-6 lg:px-[30px]">
                            ...
                            <ul class="flex flex-col gap-0.5 md:gap-1 text-sm md:text-base text-[#515151]">
                                ...
                                <li class="flex items-start flex-col md:flex-row">
                                    ...
                                    <span class="flex-1 [text-indent:-8px] pl-1">:
                                ...
                                <li class="flex items-start flex-col md:flex-row">
                                    ...
                                    <span class="flex-1 [text-indent:-8px] pl-1">: {{
                                        (!empty($invoiceInfo->customer->phone)
                                        ?
                                ...
                                <li class="flex items-start flex-col md:flex-row">
                                    ...
                                    <span class="flex-1 [text-indent:-8px] pl-1">: {{
                                        (!empty($invoiceInfo->customer->address) ?
                ...
                {{-- <div
                    class="grid md:grid-cols-2 gap-1 md:gap-0 p-2 md:p-0 my-5 bg-[rgba(237,242,255,0.40)] rounded-[10px] border border-[#D5E1FF]">
                    <div class="flex gap-2.5 md:justify-center md:border-e-2 px-3 md:p-5">
                        <span class="text-black">Order ID: </span>
                        <span>{{ $order->order_no }}</span>
                    </div>

                    <div class="flex gap-2.5 md:justify-center px-3 md:p-5">
                ...
                <div class="overflow-x-auto">
                    ...
                    <table
                        class="w-full border text-base rounded-[10px] bg-white mb-0 [&_th]:px-3 [&_th]:py-2.5 [&_td]:px-3 [&_td]:py-2.5 [&_td]:border [&_th]:border [&_th]:border-[#D5E1FF]">
                        <tr class="text-left bg-[#E5E8F3] text-[#0A0A0A]">
                            {{-- <th class="computer_header px-3 py-2 border border-[#D5E1FF]">SL</th> --}}
                            <th>Order Details</th>
                            <th class="computer_header w-[185px]">
                            </th>
                            <th class="mobile_header w-9">
                            </th>
                            <th></th>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-start ">
                                <div>
                                    ...
                                    <p>
                                        <span class="text-black font-bold">Billing Type: </span>
                                        <span>{{ $order->billType?->name }}</span>
                                    </p>

                                    <p>
                                        <span class="text-black font-bold">Order Date: </span>
                                        ...
                                        <p>
                                            ...
                                            <span>
                                                @if(!empty($order->orderItem))
                                                    ...
                                                    @for ($i = 0; $i < $itemQty; $i++)
                                                    <?php // $mainUrl=parse_url($order->orderItem[$i]->url);
                                                        // echo $mainUrl['host'];
                                                        ?>,
                                    @endfor
                                    @endif
                        ...
                        <tr class="odd:bg-[#F9FCFF] group">
                            {{-- <td
                                class="computer_header w-10 border group-odd:border-[#D5E1FF] py-2 text-[#515151] text-lg text-center ">
                                {{ $row + 1 }}
                            </td> --}}

                            <td colspan="2" class="border group-odd:border-[#D5E1FF] text-[#515151]">
                            ...
                            <td class="w-40 border-r-0 group-odd:border-[#D5E1FF] text-[#515151] text-right">
                                ${{ $items->total }}
                            </td>
                        </tr>
                        @endforeach
                        ...
                        <tr>
                            <td rowspan="5" class="computer_view text-center text-[#515151]  ">
                                &nbsp;
                            </td>

                            <td class="computer_header text-left text-[#515151]  ">
                                Sub Total
                            </td>

                            <td colspan="2" class="mobile_header text-left text-[#515151]   ">
                                Sub Total
                            </td>

                            <td class=" w-40 text-[#515151] text-right  ">
                                ${{ $order->subtotal }}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class=" text-[#515151] text-right">
                        ...
                        <tr>
                            <th class="computer_header border-r-0 text-left text-[#515151]  ">
                                Total
                            </th>

                            <th colspan="2" class="mobile_header text-left text-[#515151]  ">
                                Total
                            </th>

                            <th class="text-[#515151] text-right">
                                ${{ $order->grand_total }}
                            </th>
                        </tr>
                    </table>
            ...
            <div class="sticky top-4">
                <div class="rounded-[10px] border p-4 pb-8 border-[#D5E1FF] overflow-hidden grid gap-5">
                    <h2 class="text-xl font-bold uppercase text-[#031F42]  whitespace-nowrap">Total Order Summery
                    </h2>

                    <div
                        class="flex flex-col text-lg text-black [&_>_div]:flex [&_>_div]:items-center [&_>_div]:border-b [&_>_div]:justify-between [&_>_div]:font-semibold [&_>_div]:py-2">
                        <div>
                            <span>Sub Total</span>
                        ...
                        <div>
                            <span>Total</span>
                            <span>${{ $invoiceInfo->grand_total }}</span>
                        </div>
                    </div>
                    ...
                    @if ($invoiceInfo->status != 'paid')
                    <div class="p-4 pb-10 relative rounded border grid gap-6">
                        <div class="flex items-center justify-between  text-white bg-[#1F2ED3]">
                            <div class="flex items-center gap-2 text-xl p-3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"
                                    fill="none" class="text-2xl text-brand">
                                    <path
                            ...
                            <span class="text-2xl font-bold p-3 bg-[#051279]">${{ $invoiceInfo->grand_total }}</span>
                        </div>

                        <form action="{{url('stripe/payment', $invoiceInfo->ref_code)}}" method="post" id="payment-form"
                            class="border rounded">
                            @csrf

                            <div class="grid gap-3">
                                <label for="card-element" class="p-3 border-b text-[#515151] text-base bg-gray-50">
                                ...
                                <div id="card-errors" class="text-red-600 px-4 text-sm" role="alert"></div>
                            </div>

                            <div class="p-3 border-t bg-gray-50">
                                <button
                                    class="bg-[#1F2ED3] w-full p-3 text-center text-lg rounded text-white font-normal">
                                    Confirm Payment
                                </button>
                            </div>
                        </form>

                        <p class="text-base text-[#515151] tracking-wider">Note: any kind of problem with payment,
                            please
                            contact
                            <strong class="font-bold text-black">hello@linksposting.com.</strong>
                        </p>

                        <div
                            class="bg-white whitespace-nowrap px-3 font-medium absolute bottom-0 translate-y-1/2 left-1/2 -translate-x-1/2">
                            Powered by <span class="text-[#635DC9] font-bold text-2xl">Stripe</span>
                        </div>
                    </div>
                    @endif
                </div>
                ...
                <div class="flex justify-center items-center gap-4   mt-5">
                    <a href="{{ url('download-invoice', $invoiceInfo->ref_code) }}" onclick="downloadPDF(event)"
                        class="primary-btn !bg-secondary rounded-full px-6">
                        Download
                    </a>

                    <a href="{{ url('download-invoice', $invoiceInfo->ref_code) }}" target="_blank"
                        class="primary-btn border !bg-transparent !text-secondary !border-secondary hover:!text-white hover:!bg-secondary rounded-full px-6">
                        View PDF
                    </a>
                </div>
            </div>
...
<script>
    ...
    const stripe = Stripe("{{config('stripe.strip_pk')}}");
