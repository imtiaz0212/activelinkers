    ...
    <div class="container">
        <div class="grid xl:grid-cols-[8fr_4fr] items-start gap-5">
            <div>
                ...
                {{-- Cards --}}
                <div class="grid md:grid-cols-2 lg:grid-cols-4 my-5 gap-3">
                    @foreach ($cardData as $key => $row)
                    <div
                        class="flex flex-col items-center text-center  overflow-hidden bg-[rgba(237,242,255,0.40)] rounded-[10px] border border-[#D5E1FF] p-3">
                    ...
                    <div
                        class="flex flex-col items-center text-center  overflow-hidden {{$invoiceInfo->status == 'paid' ? 'bg-[#FAFFF9] border-[rgba(0,128,0,0.20)]' : 'bg-[#FFF9F9] border-[rgba(255,0,0,0.20)]'}} [&.unpaid]: [&.unpaid]: rounded-[10px] border p-3">
