...
<?php
    $cardData = [
        [
            ...
            'value' =>  !empty($invoiceInfo->created) ? date('M d, Y', strtotime($invoiceInfo->created)) : '',
        ],
        [
            'title' => 'Invoice No',
                ...
                <div class="lg:border-e-2 px-5 md:px-6 lg:px-[30px]">
                    ...
                    <ul class="flex flex-col gap-0.5 md:gap-1 text-sm md:text-base lg:text-lg text-[#515151]">
                        <li class="flex items-start flex-col md:flex-row">
                            ...
                            <span class="flex-1 [text-indent:-8px] pl-1">: {{ (!empty( $siteInfo->site_name) ?
                                $siteInfo->site_name : "Linksposting") }}</span>
                        </li>
                        ...
                        <li class="flex items-start flex-col md:flex-row">
                            <span class="text-black w-20 md:w-24 shrink-0">Phone </span>
                        ...
                        <li class="flex items-start flex-col md:flex-row">
                            ...
                            <span class="flex-1 [text-indent:-8px] pl-1">: {{ (!empty($siteInfo->location) ?
                                $siteInfo->location : "N/A") }}</span>
                        </li>
                    </ul>
                </div>
        ...
        <div class="mt-4 rounded-[10px] border border-[#D5E1FF] overflow-x-auto">
            ...
            <table class="w-full mb-0">
                <tr class="text-left bg-[#E5E8F3] text-[#0A0A0A]">
                    <th class="computer_header p-[20px] border border-[#D5E1FF]">SL</th>
                    <th class="p-[20px] border border-[#D5E1FF] border-r-0">Website name</th>
                    <th class="computer_header w-[185px] p-[20px] border border-[#D5E1FF] border-l-0"></th>
                    <th class="mobile_header w-[35px] p-[20px] border border-[#D5E1FF] border-l-0"></th>
                    <th class="p-[20px] border border-[#D5E1FF]">Price</th>
                </tr>
                @foreach ($order->orderItem as $row => $items)
                <tr class="odd:bg-[#F9FCFF] group">
                    <td
                        class="computer_header w-10 border group-odd:border-[#D5E1FF] py-3 text-[#515151] text-lg text-center ">
                        {{ $row + 1 }}
                    </td>

                    <td colspan="2" class="border group-odd:border-[#D5E1FF] py-3 text-[#515151] text-lg px-4">
                    ...
                    <td class="w-40 border group-odd:border-[#D5E1FF] py-3 text-[#515151] text-lg px-4">
                        ${{ $items->total }}
                    </td>
                </tr>
                @endforeach
                ...
                <tr>
                    <th colspan="2" rowspan="5"
                        class="computer_view text-center px-4 border py-3 text-[#515151] text-lg leading-[20px] ">
                        &nbsp;
                    </th>

                    <th class="computer_header text-left px-4 border py-3 text-[#515151] text-lg leading-[20px] ">
                        Sub Total
                    </th>

                    <th colspan="2"
                        class="mobile_header text-left px-4 border py-3 text-[#515151] text-lg leading-[20px] ">
                        Sub Total
                    </th>

                    <th class="border text-left px-4 w-40 py-3 text-[#515151] text-lg leading-[20px]">
                        ${{ $order->subtotal }}
                    </th>
                </tr>
                ...
                <tr>
                    ...
                    <th class="border text-left px-4 py-3 text-[#515151] text-lg leading-[20px]">
                ...
                <tr>
                    <th
                        class="computer_header text-left px-4 border border-b-0 py-3 text-[#515151] text-2xl leading-[20px]">
                        Total
                    </th>

                    <th colspan="2"
                        class="mobile_header text-left px-4 border border-b-0 py-3 text-[#515151] text-2xl leading-[20px]">
                        Total
                    </th>

                    <th class="border text-left px-4 border-b-0 py-3 text-[#515151] text-2xl leading-[20px]">
                        ${{ $order->grand_total }}
                    </th>
                </tr>
            </table>
